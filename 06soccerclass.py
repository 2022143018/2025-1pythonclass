...
class SoccerPlayer(object):
    ...
    def __str__(self):
        return f"저의 이름은 {self.name}. 위치는 {self.position}, 번호는 {self.back_number}번 입니다. 화이팅"
...
# 첫번째 선수로 messi 생성
messi = SoccerPlayer(players[0], players[0][1], players[0][2])
print(messi.name)
...
# print(player_object[2])
# print(player_object[3])
# print(player_object[4])
